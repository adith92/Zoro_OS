...
- User API Keys for VYNAA / VtechAPI are retrieved via user settings, stored strictly in LocalStorage (client-side only).
...
## VynaaSafety Module
- Zoro OS classifies the 671 endpoints from VtechAPI into Safe vs Unsafe categories.
